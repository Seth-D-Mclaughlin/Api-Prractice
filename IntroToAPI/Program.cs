...
namespace IntroToAPI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var test = service.GetAsync<Move>("https://pokeapi.co/api/v2/pokemon/151").Result;
            Console.WriteLine(anotherPokemon.name);
            Console.WriteLine(test.move);

            var listOfPokemon = service.GetAsync<ListOfPokemon>("https://pokeapi.co/api/v2/pokemon?offset=20&limit=40").Result;
